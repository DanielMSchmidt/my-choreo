...
export type StepsQuery = { __typename?: "query_root" } & {
  choreo: Array<
    { __typename?: "choreo" } & Pick<Choreo, "name"> & {
        steps: Array<
          { __typename?: "step" } & Pick<Step, "timing" | "comment">
        >;
      }
  >;
};
...
export type AddStepMutation = { __typename?: "mutation_root" } & {
  insert_step: Maybe<
    { __typename?: "step_mutation_response" } & Pick<
...
export type CreateChoreoMutation = { __typename?: "mutation_root" } & {
  insert_choreo: Maybe<
    { __typename?: "choreo_mutation_response" } & {
      returning: Array<
        { __typename?: "choreo" } & Pick<Choreo, "id" | "public_id_prefix">
      >;
    }
  >;
};
...
`;
export type StepsComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<StepsQuery, StepsQueryVariables>,
  "query"
> &
  ({ variables: StepsQueryVariables; skip?: boolean } | { skip: boolean });

export const StepsComponent = (props: StepsComponentProps) => (
  <ApolloReactComponents.Query<StepsQuery, StepsQueryVariables>
    query={StepsDocument}
    {...props}
  />
);

export type StepsProps<TChildProps = {}> = ApolloReactHoc.DataProps<
  StepsQuery,
  StepsQueryVariables
> &
  TChildProps;
export function withSteps<TProps, TChildProps = {}>(
...
export const AddStepDocument = gql`
  mutation addStep($choreoId: Int!, $timing: Int!) {
    insert_step(objects: { choreo_id: $choreoId, timing: $timing }) {
      affected_rows
    }
  }
`;
export type AddStepMutationFn = ApolloReactCommon.MutationFunction<
  AddStepMutation,
  AddStepMutationVariables
>;
export type AddStepComponentProps = Omit<
...
export const AddStepComponent = (props: AddStepComponentProps) => (
  <ApolloReactComponents.Mutation<AddStepMutation, AddStepMutationVariables>
    mutation={AddStepDocument}
    {...props}
  />
);

export type AddStepProps<TChildProps = {}> = ApolloReactHoc.MutateProps<
  AddStepMutation,
  AddStepMutationVariables
> &
  TChildProps;
export function withAddStep<TProps, TChildProps = {}>(
  operationOptions?: ApolloReactHoc.OperationOption<
    TProps,
    AddStepMutation,
    AddStepMutationVariables,
...
export function useAddStepMutation(
  ...
  return ApolloReactHooks.useMutation<
    AddStepMutation,
    AddStepMutationVariables
  >(AddStepDocument, baseOptions);
}
export type AddStepMutationHookResult = ReturnType<typeof useAddStepMutation>;
export type AddStepMutationResult = ApolloReactCommon.MutationResult<
  AddStepMutation
>;
export type AddStepMutationOptions = ApolloReactCommon.BaseMutationOptions<
  AddStepMutation,
  AddStepMutationVariables
>;
...
`;
export type CreateChoreoMutationFn = ApolloReactCommon.MutationFunction<
  CreateChoreoMutation,
  CreateChoreoMutationVariables
>;
export type CreateChoreoComponentProps = Omit<
  ApolloReactComponents.MutationComponentOptions<
    CreateChoreoMutation,
    CreateChoreoMutationVariables
  >,
...
export const CreateChoreoComponent = (props: CreateChoreoComponentProps) => (
  <ApolloReactComponents.Mutation<
    ...
    CreateChoreoMutationVariables
  >
    mutation={CreateChoreoDocument}
    {...props}
  />
);

export type CreateChoreoProps<TChildProps = {}> = ApolloReactHoc.MutateProps<
  CreateChoreoMutation,
  CreateChoreoMutationVariables
> &
  TChildProps;
export function withCreateChoreo<TProps, TChildProps = {}>(
  operationOptions?: ApolloReactHoc.OperationOption<
    TProps,
    CreateChoreoMutation,
    CreateChoreoMutationVariables,
  ...
  return ApolloReactHoc.withMutation<
    ...
    CreateChoreoMutationVariables,
    CreateChoreoProps<TChildProps>
  >(CreateChoreoDocument, {
    alias: "withCreateChoreo",
    ...operationOptions
  });
}

export function useCreateChoreoMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateChoreoMutation,
    CreateChoreoMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateChoreoMutation,
    CreateChoreoMutationVariables
  >(CreateChoreoDocument, baseOptions);
}
export type CreateChoreoMutationHookResult = ReturnType<
  typeof useCreateChoreoMutation
>;
export type CreateChoreoMutationResult = ApolloReactCommon.MutationResult<
  CreateChoreoMutation
>;
export type CreateChoreoMutationOptions = ApolloReactCommon.BaseMutationOptions<
  CreateChoreoMutation,
  CreateChoreoMutationVariables
>;
